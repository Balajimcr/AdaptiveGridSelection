...
namespace HAG {
    ...
    /**
     * @brief Generates a fixed grid of points within an image.
     *
     * @param distortionMagnitude normalised magniture of gradient in the Range ( 0 to 1 ).
     * @param fixedGridPoints A vector to store the generated grid points.
     * @param gridX The number of grid points along the horizontal axis.
     * @param gridY The number of grid points along the vertical axis.
     */
    ...
    /**
     * @brief Adaptive HAG grid generation
     *
     * This function generates an adaptive grid of points based on the magnitude of distortion
     * in an image. It first creates a fixed grid and then adds adaptive points where the
     * distortion exceeds a specified threshold. OpenMP is used to parallelize the grid
     * generation process, improving performance.
     *
     * @param magnitudeOfDistortion The input image representing the magnitude of distortion.
     * @param adaptiveGridPoints A vector to store the generated grid points (fixed and adaptive).
     * @param gridX The number of grid cells along the horizontal axis.
     * @param gridY The number of grid cells along the vertical axis.
     * @param lowThreshold The threshold value for distortion to add adaptive points.
     */
